...
const data = [
  {
    ...
    personal: {
      ...
      subtitle:
        'Amo la tecnologia e i modi in cui essa può migliorare la vita di tutti.',
      ...
      },
      {
        ...
        values: [
          ...
          },
          {
            name: 'Backend',
            value:
              'Node Express, Strapi, Python Flask, PHP, Laravel, WordPress, SQL, MySQL, SQLite, MongoDB, JSON API ...',
          },
          {
            name: 'Mobile',
          ...
          },
          {
            name: 'Altro',
            value:
              'Adobe Creative Suite, Solidity, Cardano Blockchain, AWS, Proxmox, JAVA (base), R, C++, GraphQL etc ...',
          },
        ],
      },
      {
        ...
        values: [
          {
            name: null,
            value:
              "3D Printing, Ciclismo, Meditazione, VR, Arduino e laser cutters, la Musica e tutta l'Arte in generale, ciò che luccica di vita propria, e ciò che anche se spesso sottovalutato, ha un intrinsico potere per cambiare il mondo.",
          },
        ],
      },
    ],
        ...
        values: [
          {
            ...
            thumbnail: Maresi,
            description:
              "Un'app per scoprire la qualità delle acque vicine, e le relative misurazioni batteriche",
          ...
          },
          {
            ...
            thumbnail: f8lite,
            description:
              'Software gestionale utilizzato dalla ASP Bagheria per il tracciamento pazienti positivi al COVID-19',
  ...
  },
  {
    ...
    personal: {
      ...
      role: 'Full Stack Web Developer',
      subtitle:
        'I love technology for the ways it can improve lives on this planet, and beyond.',
        ...
        values: [
          {
            name: null,
            value:
              '3D Printing, Cycling, Meditating, VR, Arduino and laser cutters, Music and all Arts in general, what shines with its own light, and what is considered undervalued, yet, holds an intrinsic power to change the world.',
          },
        ],
      },
    ],
        ...
        values: [
          {
            ...
            thumbnail: Maresi,
            description:
              'An APP built to discover the quality of the oceans around us, and their bacteria levels',
          ...
          },
          {
            ...
            thumbnail: f8lite,
            description:
              'Project Management Software adopted by the Local Health Authority (ASP Bagheria) to keep track of COVID-19 positive patients',
